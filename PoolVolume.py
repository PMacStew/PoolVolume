...
def conversion_questions():
    ...
    print("If m type 6")
    print("If km type 7")
    conversion_value = float(input("What number will you be converting: "))
    conversion_type1 = int(input("What unit will you convert: "))
    conversion_type2 = int(input("What unit will you be converting to: "))


# This prints the final converted value
def conversion_result():
    global conversion_vlaue
    if conversion_type1 == conversion_type2:
        print("Your converted value is " + str(conversion_value))
...
if first_choice == 1:
    ...
    conversion_scale = int(input("If 3D object press 1. If 2D object press 2. If 1D object press 3: "))
